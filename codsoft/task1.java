...
public class task1 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        Random rand = new Random();   // function for generating random number
        ...
        for (int i = 1; i <= rounds; i++) {
            ...
            switch (limits) {
                case 1: {
                    ...
                    whileloop: while (true) {
                        ...
                        if (guess > randomNumber) {
                            ...
                            System.out.println(
                                    "The number " + guess + " is a correct Guess .\nCongrats it took you "
                                            + count + " attempts.");
                            break whileloop;
                        }
                        count++;
                ...
                case 3:{  
                	System.out.println("choosen  Hard .\nHence, there is a Limit to number of attempts");
                	System.out.println(
                        "The limit is just 3.\nIf you have guessed the number in 3or less attempts you have won the game.\n Else you will lose the game.\n");
                int randomNumber = 1 + rand.nextInt(100);
                System.out.println("Random Number has been generated...");

                int count = 1;
                whileloop: while (count <= 3) {
                    System.out.println("\nNo of guesses remaining : " + (4 - count) + " ...\n");
                    System.out.print("Enter you guess number " + count + ": ");
                    int guess = sc.nextInt();
                    if (guess > randomNumber) {
                        System.out.println("The number " + guess
